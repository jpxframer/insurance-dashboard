...
/** A bubble in the open thread. `draft` is Sarah's unsent reply. */
export type ThreadMessage = {
  id: string;
  author: string;
  initials: string;
  avatarTone: InboxAvatarTone;
  /** "Today · 9:41 AM" on the received message, "Draft" on the reply. */
  meta: string;
...
export const inboxThread = {
  subject: "Re: Claim CLM-8241 — repair timeline?",
  tag: { label: "CLAIM", tone: "claim" } as InboxTag,
